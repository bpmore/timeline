...
/*
  ...
  Plugin URI:http://litbuilt.com
  Description: Forked to add Genesis Framework functionality - specifically Genesis SEO and Genesis layouts. Timeline is a responsive wordpress plugin that allows you to create a verticle storyline. Create posts, set images and date then Timeline will automatically populate these posts in chronological order, based on the year and date. Original author is Narinder Singh.
  Version:2.0
  Author: Brent Passmore
  Modified by: Brent Passmore
  License: GPL2
...
/** Configuration * */
if (!defined('TIMELINE_VERSION_CURRENT'))
    define('TIMELINE_VERSION_CURRENT', '1.0.9');
...
if (!class_exists('Timeline')) {
    ...
    class Timeline {
        ...
        public function __construct() {
            ...
            // timeline post type
           require plugin_dir_path(__FILE__) . 'includes/timeline_posttype.php';
            $timeline_posttype = new Timeline_Posttype();
             ...
             * View
             */
            require plugin_dir_path(__FILE__) . 'includes/timline_template.php';
            new Timeline_Template();
            ...
            add_image_size('timeline_custom_size', '350', '120', true);
...
// END public static funct
        ...
        function plugin_settings_link($links) {
            $settings_link = '<a href="options-general.php?page=timeline_page">Settings</a>';
      ...
      function ctl_option_panel() {
             ...
             */
            $config = array(
                'menu' => array('top' => 'timeline'), //sub page to settings page
                'page_title' => __('Timeline', 'apc'), //The name of this page 
                'capability' => 'edit_themes', // The capability needed to view the page 
                'option_group' => 'timeline_options', //the name of the option to create in the database
                'id' => 'timeline_page', // meta box id, unique per page
    ...
    $options_panel->OpenTab('options_1');
        ...
        $options_panel->Title(__("General Settings", "apc"));
         ...
         //   $options_panel->addParagraph(__("This is a simple paragraph", "apc"));
            //text field
            $options_panel->addText('title_text', array('name' => __('Title ', 'apc'), 'std' => 'Timeline', 'desc' => __('', 'apc')));
          ...
          $options_panel->addRadio('display_readmore', array('yes' => 'Yes',
			...
			$options_panel->addRadio('disable_months', array('yes' => 'Yes',
                'no' => 'no'), array('name' => __('Disable Timeline Months ?', 'apc'), 'std' => array('no'), 'desc' => __('', 'apc')));
  ...
  //Now Just for the fun I'll add Help tabs
        ...
        public function ctl_add_tinymce_plugin( $plugin_array ) {
            $plugin_array['timeline'] = plugins_url( 'timeline/includes/js/timeline-button-script.js' );
        ...
        function ctl_add_tinymce_button( $buttons ) {
            array_push( $buttons, 'timeline_shortcode_button' );
            // Print all buttons
            // var_dump( $buttons );
            return $buttons;
    }
